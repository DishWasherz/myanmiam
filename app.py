...
@app.route("/data")
def get_data():
    df = pd.read_csv(data_path + 'all_data_v4.csv')
    ...
    cols_to_keep = ['age_segment','id','Township','timestamp','population','longitude','latitude','AC_output_yearly','pcode_ts','hh_t','YR 1','YR 2','YR 3','YR 4','YR 5','YR 6','Total_Score','Total_yearly_demand','Normalized AC output','Normalized Ability to Pay','Normalized demand']
