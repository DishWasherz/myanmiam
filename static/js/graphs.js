...
function makeGraphs(error, recordsJson) {
	...
	var locationdDim = ndx.dimension(function(d) { return d["pcode_ts"]; });
	...
	var timeChart = dc.numberDisplay("#time-chart");
  ...
  //
	...
	dcCharts = [timeChart, locationChart, ageSegmentChart];
